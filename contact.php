...
<body>
    <div class="section">
        <h2 style="text-align: center; color: #007bff;">Contact Us</h2>
        <br>
        <br>
        <ul class="contact-list" style="margin-left: 10px;">
            <li>
...
<div class="section">
    <h2 style="text-align: center; color: #007bff;"> Find Us on Google</h2><br>
    <div class="container">
